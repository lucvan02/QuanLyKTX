      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <form action="admin/changeInfo.htm" class="tm-edit-product-form" <%-- modelAttribute="admin" --%> method="POST" >
           ...
           <div class="row">
			 ...
			 <input class="form-control"
						type="date" name="ngaySinh" value=""/>
						<span class="loi">{loiNgaySinh}</span></div>
	    		
	    		<div class="form-group mb-3 col-xs-12 col-sm-6">
					<label class="form-label">Giới Tính:</label> <br>
					 	<%-- <label><f:radiobuton path="gioiTinh" value="1" /> Nam</label> <br>
						<label><f:radiobuton path="gioiTinh" value="0" /> Nữ</label>--%>	
